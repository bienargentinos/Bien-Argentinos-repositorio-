    ...
    const contenido = `
      ...
      <div class="facturas-page-container">
        ...
        <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap; margin-bottom: 20px;">
          ...
          <button id="chip-origen-marcos" type="button" onclick="cambiarChipOrigen('Marcos IA')" style="appearance: none; cursor: pointer; background: #FFFFFF; border: 1px solid #E2E8F0; border-radius: 999px; padding: 5px 14px; font-size: 12.5px; font-weight: 600; color: #475569; display: inline-flex; align-items: center; gap: 6px; transition: all .15s ease;">
            <i class="ph ph-robot" style="font-size: 14px; color: #2E6FC0;"></i><span>Marcos IA</span>
          </button>
