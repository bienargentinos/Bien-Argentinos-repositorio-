...
## Los pedidos del motor NO están más acá

Estaban, y era el lugar equivocado: este archivo es **tu informe de arranque**, no un buzón. Se
mudaron a **`docs/para-el-portal.md`**, que es donde el motor y el panel te dejan lo que necesitan
de vos.

Lo que se mudó: la ruta autenticada para que el vecino abra su expensa, el filtro por unidad, y el
`store` de sesiones del portal.
